...
// Package scheduler — C27 tenant-leak gate for integration tests (M46).
//
...
//
//   - schedOpenOrSkip registers Close via t.Cleanup at open time, so
...
const c27TenantOrgPrefix = "itest-sched-"
